...
objText:string = `Bacon ipsum dolor amet chislic pork belly ham, rump biltong short ribs hamburger ribeye prosciutto bacon corned beef pancetta ham hock tri-tip.
  ...
  Rump buffalo drumstick shoulder fatback tri-tip swine doner t-bone pancetta. Boudin rump venison tail bresaola pork loin buffalo fatback t-bone frankfurter burgdoggen
  ham hock bacon. Tongue turkey fatback shoulder capicola pastrami. Pig jowl beef ribs salami, capicola shoulder ground round turkey fatback corned beef. Jerky landjaeger kevin rump drumstick ribeye sirloin. Sausage boudin bacon, andouille leberkas pork short ribs strip steak meatloaf buffalo jerky cow. Cow bresaola cupim pork belly jerky.
  `;
